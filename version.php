...
$module->version  = 2012101000;  // The current module version (Date: YYYYMMDDXX)
$module->release  = 'Referentiel v 8.02 for Moodle 2.4 - 2012-12-11';    // User-friendly date of release
