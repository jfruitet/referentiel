...
$module->version  = 2013062405;  // The current module version (Date: YYYYMMDDXX)
$module->release  = 'Referentiel v 8.08 for Moodle 2.4 et 2.5 without scales support - Release 2014-03-24';    // User-friendly date of release
